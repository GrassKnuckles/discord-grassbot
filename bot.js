...
const replies = [
  ...
  "The Nuclear Bomb has saved more lives than it has killed",
  "The Sun never set on the British Empire, because even god didn't trust the Brits in the dark",
  "There were many Crusades, some of which almost didn't fail",
  "'Athlete's Heart' is a condition where the heart of an athlete has adapted to their strenuous and vigorous excercise and has developed largr cardiac muscles to pump more blood. This condition can cause cardiac arrests very frequently to those athletes.",
  "Something The Ancient Egyptians never said was "Excuse me." or "I'm sorry." Some might argue that it was because they were rude or stubborn. But I think it was probably because they didn't speak English."
]
